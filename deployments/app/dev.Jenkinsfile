      ...
      steps {
            ...
            //   }
              dir('infra/ansible') {
                  ...
                  ansible-playbook -i inventories/aws/dev.aws_ec2.yml plays/challenge/site.yml --ssh-common-args="-o StrictHostKeyChecking="no" -o ProxyCommand="ssh -W %h:%p ubuntu@$BASTION:22"" --key-file key_file
